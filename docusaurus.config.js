...
const config = {
  title: 'DebugDog',
  titleDelimiter: '-',
  url: 'https://www.wangwren.com/',
  baseUrl: '/',
  favicon: 'img/favicon.ico',
  organizationName: 'debugDog',
  projectName: 'blog',
  ...
  themeConfig: {
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: 'GitHub',
              href: 'https://github.com/wangwren',
            },
            {
              label: '掘金',
    ...
    socials: {
      github: 'https://github.com/wangwren',
    ...
    [
      path.resolve(__dirname, './src/plugin/plugin-content-blog'),
      {
        ...
        editUrl: ({ locale, blogDirPath, blogPath, permalink }) =>
          `https://github.com/wangwren/wangwren.github.io/edit/main/${blogDirPath}/${blogPath}`,
        editLocalizedFiles: false,
        blogDescription: 'debug的个人博客',
        blogSidebarCount: 10,
